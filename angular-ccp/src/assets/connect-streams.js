...
(function e(t, n, r) {
  ...
  110: [function (require, module, exports) {
    ...
    "../internal/baseAssign": 71,
    "../internal/createAssigner": 89
  }],
...
(function () {
  ...
  connect.PopupManager.prototype.open = function (url, name) {
    ...
    if (now - then > ONE_DAY_MILLIS) {
      var win = window.open('', name, 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1,height=1');
      connectLoginWin = win;
      if (win.location !== url) {
    ...
    connect.core.getEventBus().subscribe(connect.EventType.ACK_TIMEOUT, function () {
      ...
      if (params.loginPopup !== false) {
        try {
          ...
          var loginUrl = params.absoluteLoginUrl || createLoginUrl(params);
...
(function () {
  ...
  ClientEngine.prototype.refreshAuthToken = function (callbacks) {
    ...
    this.client.call(connect.ClientMethods.GET_NEW_AUTH_TOKEN, {
